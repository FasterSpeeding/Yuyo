...
- The descriptors returned by the `as_` decorators in [yuyo.components][] are
  now hidden when accessed directly on classes. The decorated callback will be
  directly exposed as the class attribute now instead.
...
[Unreleased]: https://github.com/FasterSpeeding/Yuyo/compare/v1.14.0...HEAD
