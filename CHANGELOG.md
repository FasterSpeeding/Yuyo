...
- Message component has support for loading components from class attributes again.
  This time this support has been added to [yuyo.components.ActionColumnExecutor][]
  and uses [yuyo.components.].
