...
- Rename `ErrorManager.with_rule` to [ErrorManager.add_rule][yuyo.backoff.ErrorManager.add_rule]
...
[Unreleased]: https://github.com/FasterSpeeding/Yuyo/compare/v1.6.1a1...HEAD
